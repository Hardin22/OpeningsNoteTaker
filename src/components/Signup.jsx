...
const Signup = ({ onClose, toggle }) => {
    ...
    const handleSignup = async (e) => {
        ...
        try {
            ...
            setMessage(
                'Registrazione completata! Per favore controlla la tua email e verifica il tuo account prima di accedere.'
            );
    ...
    const handleGoogleSignup = async () => {
        ...
        try {
            ...
            console.log('Utente registrato con Google:', result.user);
    ...
    const resendVerificationEmail = async () => {
        if (auth.currentUser) {
            try {
                ...
                setError("Errore nell'invio dell'email: " + err.message);
            } finally {
                setLoading(false);
            }
        } else {
            setError('Nessun utente attualmente autenticato');
        }
    };
    ...
    return (
        <div className="text-white">
                ...
                <div className="text-center">
                    <div className="bg-blue-900/20 border border-blue-700/30 rounded-lg p-4 mb-4">
                        <p className="text-gray-300 mb-2">
                            Per favore controlla la tua casella email e clicca sul link di verifica.
                        </p>
                        <p className="text-sm text-gray-400">
                            Se non vedi l'email, controlla nella cartella spam.
                        </p>
                    </div>
            ...
            <div className="text-center mt-5">
                <p className="text-sm text-gray-400">
                    Hai già un account?{' '}
                    <button className="text-blue-400 hover:underline font-light" onClick={toggle}>
                        Accedi
                    </button>
                </p>
            </div>
